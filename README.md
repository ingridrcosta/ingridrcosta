...
Durante toda essa jornada, descobri que a minha verdadeira paixão está na **infraestrutura cloud**, com um carinho especial por ambientes Microsoft. ☁️

### 🚀 Minha Jornada na Nuvem
Estou ingressando de cabeça na área Cloud através do Azure, ambiente no qual me familiarizei mais em relação à AWS. 

Atualmente possuo as seguintes certificações fundacionais:
* **Microsoft Azure Fundamentals (AZ-900)** 🟦
* **AWS Certified Cloud Practitioner (CLF-C02)** 🟧

### 🗡️ Meu Runbook & Laboratório (Hyrule)
Estou utilizando o GitHub como meu *runbook* pessoal. Aqui você encontrará:
* Estudos e automações testadas no meu laboratório (chamado carinhosamente de **Hyrule** 🛡️).
* Documentações de *troubleshooting* baseadas em resoluções do meu dia a dia profissional.

💡 *Caso tenha gostado de alguma ideia ou script, fique à vontade para clonar. Espero poder te ajudar!*
